...
const ASSETS = Object.freeze([
  ...
  asset("/sde_tursatt_live_arrival.js", "sde_tursatt_live_arrival.js", "application/javascript; charset=utf-8", "private, max-age=600, must-revalidate"),
  ...
  asset("/assets/vendor/onnxruntime-web/ort.wasm.min.mjs", "assets/vendor/onnxruntime-web/ort.wasm.min.mjs", "application/javascript; charset=utf-8", "private, max-age=31536000, immutable"),
  asset("/assets/vendor/onnxruntime-web/ort-wasm-simd-threaded.mjs", "assets/vendor/onnxruntime-web/ort-wasm-simd-threaded.mjs", "application/javascript; charset=utf-8", "private, max-age=31536000, immutable"),
  asset("/assets/vendor/onnxruntime-web/ort-wasm-simd-threaded.wasm", "assets/vendor/onnxruntime-web/ort-wasm-simd-threaded.wasm", "application/wasm", "private, max-age=31536000, immutable"),
  asset("/assets/models/gigapdf-ocr-handwriting/manifest.json", "assets/models/gigapdf-ocr-handwriting/manifest.json", "application/json; charset=utf-8", "no-store"),
  asset("/assets/models/gigapdf-ocr-handwriting/model.onnx", "assets/models/gigapdf-ocr-handwriting/model.onnx", "application/octet-stream", "private, max-age=31536000, immutable"),
  asset("/assets/models/gigapdf-ocr-handwriting/dict.txt", "assets/models/gigapdf-ocr-handwriting/dict.txt", "text/plain; charset=utf-8", "private, max-age=31536000, immutable"),
  asset("/assets/models/latin-pp-ocrv5-mobile-rec-onnx/manifest.json", "assets/models/latin-pp-ocrv5-mobile-rec-onnx/manifest.json", "application/json; charset=utf-8", "no-store"),
  asset("/assets/models/latin-pp-ocrv5-mobile-rec-onnx/inference.onnx", "assets/models/latin-pp-ocrv5-mobile-rec-onnx/inference.onnx", "application/octet-stream", "private, max-age=31536000, immutable"),
  asset("/assets/models/latin-pp-ocrv5-mobile-rec-onnx/inference.yml", "assets/models/latin-pp-ocrv5-mobile-rec-onnx/inference.yml", "text/yaml; charset=utf-8", "private, max-age=31536000, immutable"),
