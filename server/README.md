...
Rask navigering i denne README-en. Seksjonene under er organisert kronologisk som en fase-logg og kan trygt slås sammen ved behov.

- [Krav](#krav)
- [Installasjon](#installasjon)
- [Lokal drift på Mac mini](#lokal-drift-på-mac-mini)
- [Fail-closed Balise data sync contract](#fail-closed-balise-data-sync-contract)
- [Testkommandoer](#testkommandoer)
- [Repo- og filhygiene](#repo--og-filhygiene)
- [Endepunkter i denne fasen](#endepunkter-i-denne-fasen)
- [Drift, restart og backup](#drift-restart-og-backup)
- [Fremtidig action-kontrakt](#fremtidig-action-kontrakt)
- [Fremtidig kontraktstest](#fremtidig-kontraktstest)

<details>
<summary>Fase-logg B8–B48 (kronologisk arbeidshistorikk, 74 seksjoner)</summary>

- [B8A test-only action-kontrakt](#b8a-test-only-action-kontrakt)
- [B8B test-only action-kontrakt](#b8b-test-only-action-kontrakt)
- [B9B produksjonsklar idempotency-design](#b9b-produksjonsklar-idempotency-design)
- [B9D migration-plan for actions-schema](#b9d-migration-plan-for-actions-schema)
- [B10B test-only actions migration](#b10b-test-only-actions-migration)
- [B10D runtime-migration-design](#b10d-runtime-migration-design)
- [B11 read-only schema/status](#b11-read-only-schemastatus)
- [B12 test-only runtime-migration](#b12-test-only-runtime-migration)
- [B13E production migration-runner-design](#b13e-production-migration-runner-design)
- [B13F one-shot production migration-runner](#b13f-one-shot-production-migration-runner)
- [B13H production migration-runner-test](#b13h-production-migration-runner-test)
- [B13J production actions-schema migration runbook](#b13j-production-actions-schema-migration-runbook)
- [B14C test-only actions-table action](#b14c-test-only-actions-table-action)
- [B15B2B actions-table write-test](#b15b2b-actions-table-write-test)
- [B15D actions-table regression script](#b15d-actions-table-regression-script)
- [B16-B første ekte action-kontrakt](#b16-b-første-ekte-action-kontrakt)
- [B16C-B server-note testimplementering](#b16c-b-server-note-testimplementering)
- [B19-B production server-note write-runbook](#b19-b-production-server-note-write-runbook)
- [B26-B SDE recommendation acknowledgement test action](#b26-b-sde-recommendation-acknowledgement-test-action)
- [B37-A minimal operational state write-kontrakt](#b37-a-minimal-operational-state-write-kontrakt)
- [B37-B test-only operational-state endpoint skeleton](#b37-b-test-only-operational-state-endpoint-skeleton)
- [B37-F production pilot-readiness / runbook](#b37-f-production-pilot-readiness--runbook)
- [B37-I production pilot closure](#b37-i-production-pilot-closure)
- [B38-A first frontend sync scope](#b38-a-first-frontend-sync-scope)
- [B38-E frontend-write pilot-runbook](#b38-e-frontend-write-pilot-runbook)
- [B38-G test-only frontend-submit result](#b38-g-test-only-frontend-submit-result)
- [B38-H0 production-pilot dry-run result](#b38-h0-production-pilot-dry-run-result)
- [B38-H1B production-pilot preflight backup result](#b38-h1b-production-pilot-preflight-backup-result)
- [B38-H1D production-pilot runbook](#b38-h1d-production-pilot-runbook)
- [B38-H1E production-pilot write result](#b38-h1e-production-pilot-write-result)
- [B39-B SDE Shared Workspace architecture](#b39-b-sde-shared-workspace-architecture)
- [B41-A manual-assessments-notes test-write contract](#b41-a-manual-assessments-notes-test-write-contract)
- [B41-B manual-assessments-notes test-only runbook](#b41-b-manual-assessments-notes-test-only-runbook)
- [B41-F manual-assessments-notes test-resultat](#b41-f-manual-assessments-notes-test-resultat)
- [B41-E2 manual-assessments-notes idempotency/revision-resultat](#b41-e2-manual-assessments-notes-idempotencyrevision-resultat)
- [B42-A manual-assessments-notes production-pilot plan/runbook](#b42-a-manual-assessments-notes-production-pilot-planrunbook)
- [B42-F manual-assessments-notes production-pilot resultat](#b42-f-manual-assessments-notes-production-pilot-resultat)
- [B43-A manual-assessments-notes readback/UI plan](#b43-a-manual-assessments-notes-readbackui-plan)
- [B43-E manual-assessments-notes readback/UI resultat](#b43-e-manual-assessments-notes-readbackui-resultat)
- [B44-A manual-assessments-notes access/readback matrix](#b44-a-manual-assessments-notes-accessreadback-matrix)
- [B45-A SDE Shared Workspace auth/access-control contract](#b45-a-sde-shared-workspace-authaccess-control-contract)
- [B45-D — Threat model og security boundary review](#b45-d--threat-model-og-security-boundary-review)
- [B45-E — B46 readiness gate / auth implementation precheck](#b45-e--b46-readiness-gate--auth-implementation-precheck)
- [B45-F — B46 scope proposal / implementation cutline](#b45-f--b46-scope-proposal--implementation-cutline)
- [B45-G — B45 closeout og B46-A beslutningspakke](#b45-g--b45-closeout-og-b46-a-beslutningspakke)
- [B46-A — Minimal auth/access-policy skeleton](#b46-a--minimal-authaccess-policy-skeleton)
- [B46-C — Access-policy endpoint catalog og test-herding](#b46-c--access-policy-endpoint-catalog-og-test-herding)
- [B46-E — Endpoint access matrix og enforcement cutline](#b46-e--endpoint-access-matrix-og-enforcement-cutline)
- [B46-F — Policydata for OPTIONS/static/readback cutlines](#b46-f--policydata-for-optionsstaticreadback-cutlines)
- [B46-H — Final closeout for access-policy skeleton/testherding](#b46-h--final-closeout-for-access-policy-skeletontestherding)
- [B47-A — Identity/session decision record](#b47-a--identitysession-decision-record)
- [B47-C — Local/LAN pilot identity design record](#b47-c--locallan-pilot-identity-design-record)
- [B47-E — Local/LAN implementation readiness gate](#b47-e--locallan-implementation-readiness-gate)
- [B47-F — Isolert Local/LAN identity skeleton](#b47-f--isolert-locallan-identity-skeleton)
- [B47-H — Identity skeleton closeout](#b47-h--identity-skeleton-closeout)
- [B47-I — Role/scope catalog ownership decision record](#b47-i--rolescope-catalog-ownership-decision-record)
- [B47-J — Catalog parity/sync plan](#b47-j--catalog-paritysync-plan)
- [B47-K — Isolated catalog parity test](#b47-k--isolated-catalog-parity-test)
- [B47-M — Catalog parity-test closeout](#b47-m--catalog-parity-test-closeout)
- [B47-N — Expected-YELLOW resolution decision record](#b47-n--expected-yellow-resolution-decision-record)
- [B47-O — Manual assessments identity-scope fix](#b47-o--manual-assessments-identity-scope-fix)
- [B47-P — Missing identity scopes decision record](#b47-p--missing-identity-scopes-decision-record)
- [B47-Q — Missing identity scopes technical fix](#b47-q--missing-identity-scopes-technical-fix)
- [B47-S — B47 identity/security closeout and B48 readiness gate](#b47-s--b47-identitysecurity-closeout-and-b48-readiness-gate)
- [B48-A — Runtime-auth readiness decision record](#b48-a--runtime-auth-readiness-decision-record)
- [B48-B — Isolated auth-policy skeleton](#b48-b--isolated-auth-policy-skeleton)
- [B48-C-DOC — Auth runtime-boundary decision record](#b48-c-doc--auth-runtime-boundary-decision-record)
- [B48-D-DOC — Identity-source / issuer-session decision record](#b48-d-doc--identity-source--issuer-session-decision-record)
- [B48-E-DOC — Default-deny middleware/runtime test-model decision record](#b48-e-doc--default-deny-middlewareruntime-test-model-decision-record)
- [B48-F-DOC — Isolated runtime-harness scope decision record](#b48-f-doc--isolated-runtime-harness-scope-decision-record)
- [B48-G-DOC — Isolated harness result / limitation decision record](#b48-g-doc--isolated-harness-result--limitation-decision-record)
- [B48-H-DOC — Runtime-import readiness gap decision record](#b48-h-doc--runtime-import-readiness-gap-decision-record)
- [B48-I-DOC — Express-flow harness result / limitation decision record](#b48-i-doc--express-flow-harness-result--limitation-decision-record)
- [B48-J-DOC — B48 runtime-auth design/testmodell closure decision record](#b48-j-doc--b48-runtime-auth-designtestmodell-closure-decision-record)

</details>

- [SDE-SYNC-D1 shared sporplan-draft write-policy guard](#sde-sync-d1-shared-sporplan-draft-write-policy-guard)
- [Privat nattplanlagring](#privat-nattplanlagring)
