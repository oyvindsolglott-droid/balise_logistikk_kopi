...
const harnesses = [
  ...
  {name:"actual-state-action-path", path:path.join(root, "tests/sde/harnesses/sde-actual-state-action-path-harness.js"), expected:9}
];
...
process.stdout.write(`${JSON.stringify({
  ...
  scenarios:{trappedEgress:reports[0].scenarios||{},passiveBlockedSlot:reports[1].scenarios||[],recursivePrerequisite:reports[2].scenarios||[],actualStateActionPath:reports[3]||{}}
})}\n`);
