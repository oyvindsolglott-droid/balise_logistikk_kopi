...
const mutations = [
  ...
  {id:"GROUND_PLACEMENT_INFO_BANNER_REINTRODUCED",kind:"index",expected:"INV-INPUT-CLEANUP-012",apply:source=>replaceOnce(source,'<div data-sde-operational-message-host data-sde-operational-role="txp"></div>','<div class="note"><strong>Grunnoppstilling</strong> er fysisk registrert tomtestatus.</div>\n<div data-sde-operational-message-host data-sde-operational-role="txp"></div>',"ground banner")},
  {id:"PLACEMENT_SUMMARY_CHIPS_REINTRODUCED",kind:"index",expected:"INV-INPUT-CLEANUP-014",apply:source=>replaceOnce(source,'<div data-sde-operational-message-host data-sde-operational-role="txp"></div>','<div id="sharedSporplanDraftReadback">4S → 74-21</div>\n<div data-sde-operational-message-host data-sde-operational-role="txp"></div>',"summary")},
  ...
  {id:"SHARED_DRAFT_READ_BUTTON_REINTRODUCED",kind:"index",expected:"INV-INPUT-CLEANUP-016",apply:source=>replaceOnce(source,'<div data-sde-operational-message-host data-sde-operational-role="txp"></div>','<button id="sharedSporplanDraftRefreshBtn">Les delt draft</button>\n<div data-sde-operational-message-host data-sde-operational-role="txp"></div>',"read button")},
  {id:"SHARED_PARKED_WHERE_SAVE_BUTTON_REINTRODUCED",kind:"index",expected:"INV-INPUT-CLEANUP-017",apply:source=>replaceOnce(source,'<div data-sde-operational-message-host data-sde-operational-role="txp"></div>','<button id="sharedSporplanDraftSaveBtn">Lagre delt parkert-hvor</button>\n<div data-sde-operational-message-host data-sde-operational-role="txp"></div>',"save button")},
  {id:"ORPHAN_DRAFT_STATUS_TEXT_REINTRODUCED",kind:"index",expected:"INV-INPUT-CLEANUP-013",apply:source=>replaceOnce(source,'<div data-sde-operational-message-host data-sde-operational-role="txp"></div>','<div id="sharedSporplanDraftStatus">Delt sporplan aktiv</div>\n<div data-sde-operational-message-host data-sde-operational-role="txp"></div>',"status")},
