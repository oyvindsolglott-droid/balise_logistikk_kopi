...
put(
  ...
  !/data-tab="sdeNattplanErfaring"/.test(menuMarkup)
    ...
    && /const anchor = menu\.querySelector\("\.seg-turnering-graphic"\)\s*\|\| menu\.querySelector\("\.seg-vaktplan-graphic"\);/.test(syncSource)
    && /menu\.insertBefore\(button,anchor\);/.test(syncSource)
