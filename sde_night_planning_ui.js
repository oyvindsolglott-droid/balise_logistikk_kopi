(function initializeSdeNightPlanningUi(root) {
  ...
  const HTR_MODULE_SOURCES = Object.freeze([
    Object.freeze({globalName: "SdeHandwritingRecognition", source: "sde_handwriting_recognition.js?v=84bd8ab88a59ea713015820d520e2ecfb3aade3aebce8f29017dd776ef3993e6"}),
  ...
  async function getOcrAnalyzer(onProgress) {
    ...
    ocrAnalyzer = htrRuntime.createLocalHandwritingAnalyzer({
      environment: root,
      workerUrl: new URL("sde_handwriting_worker.js?v=21e163ac154a4c1ee8a68feb70d37f48f12044a52e1229e698dd5573bdfe8ea2", document.baseURI).href,
